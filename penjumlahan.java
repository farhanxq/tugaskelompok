...
public class penjumlahan {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println(jumlahAngka + " Deret Bilangan Genap: " + deretGenap);
            ...
            System.out.println(jumlahAngka + " Deret Bilangan Ganjil: " + deretGanjil);
            ...
            System.out.println(jumlahAngka + " Deret Bilangan Fibonacci: " + deretFibonacci);
